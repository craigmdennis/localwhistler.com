  ...
  */
  public function execute()
  {
      try
      {
          ...
          // Sync submodules
          exec('git submodule sync '.$this->_remote.' '.$this->_branch, $output);
          $this->log('Syncing submodules... '.implode(' ', $output));
          echo 'Syncing submodules... ';

          // Update submodules
          exec('git submodule update '.$this->_remote.' '.$this->_branch, $output);
...
$deploy->post_deploy = function() use ($deploy) {
  ...
  exec('curl http://lw-dev.simplebitdesign.com/wp/wp-admin/upgrade.php?step=upgrade_db');
